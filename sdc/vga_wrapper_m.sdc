...
# Mon May  4 06:24:05 2026
###############################################################################
current_design vga_wrapper_m
###############################################################################
# Timing Constraints
###############################################################################
...
set_output_delay 4.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {hsync_o}]
set_output_delay 4.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {irq_hblank_o}]
set_output_delay 4.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {irq_vblank_o}]
...
set_output_delay 4.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {pixel_o[0]}]
set_output_delay 4.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {pixel_o[1]}]
set_output_delay 4.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {pixel_o[2]}]
set_output_delay 4.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {pixel_o[3]}]
set_output_delay 4.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {pixel_o[4]}]
set_output_delay 4.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {pixel_o[5]}]
set_output_delay 4.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {pixel_o[6]}]
set_output_delay 4.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {pixel_o[7]}]
set_output_delay 4.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {vsync_o}]
...
# Environment
###############################################################################
set_load -pin_load 0.0334 [get_ports {hsync_o}]
set_load -pin_load 0.0334 [get_ports {irq_hblank_o}]
set_load -pin_load 0.0334 [get_ports {irq_vblank_o}]
set_load -pin_load 0.0334 [get_ports {vsync_o}]
...
set_load -pin_load 0.0334 [get_ports {pixel_o[7]}]
set_load -pin_load 0.0334 [get_ports {pixel_o[6]}]
set_load -pin_load 0.0334 [get_ports {pixel_o[5]}]
set_load -pin_load 0.0334 [get_ports {pixel_o[4]}]
set_load -pin_load 0.0334 [get_ports {pixel_o[3]}]
set_load -pin_load 0.0334 [get_ports {pixel_o[2]}]
set_load -pin_load 0.0334 [get_ports {pixel_o[1]}]
set_load -pin_load 0.0334 [get_ports {pixel_o[0]}]
