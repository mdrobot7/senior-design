...
static inline void mat4_view(mat4_t m, ugpu_fp_t cam_x, ugpu_fp_t cam_y, ugpu_fp_t cam_z, ugpu_fp_t cam_rad_x, ugpu_fp_t cam_rad_y, ugpu_fp_t cam_rad_z); // Creates a view matrix using a camera position and rotation
...
static inline void mat4_view(mat4_t m, ugpu_fp_t cam_x, ugpu_fp_t cam_y, ugpu_fp_t cam_z, ugpu_fp_t cam_rad_x, ugpu_fp_t cam_rad_y, ugpu_fp_t cam_rad_z) {
  mat4_t cam_rotation;
