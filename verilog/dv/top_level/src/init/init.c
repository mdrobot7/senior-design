...
static void init_io() {
  ...
  GPIO_QSPI2_SCK  = GPIO_MODE_USER_STD_OUTPUT;
  GPIO_QSPI2_CS   = GPIO_MODE_USER_STD_OUTPUT;
  GPIO_QSPI2_DQSM = GPIO_MODE_USER_STD_BIDIRECTIONAL;
  GPIO_QSPI2_SIO0 = GPIO_MODE_USER_STD_BIDIRECTIONAL;
  GPIO_QSPI2_SIO1 = GPIO_MODE_USER_STD_BIDIRECTIONAL;
  GPIO_QSPI2_SIO2 = GPIO_MODE_USER_STD_BIDIRECTIONAL;
  GPIO_QSPI2_SIO3 = GPIO_MODE_USER_STD_BIDIRECTIONAL;
...
static void init_cores() {
  /* irq_enable_user1(0); // TODO: test with interrupts */
  CC->INTMASK.reg = 0;
  CC->COREEN.reg  = 0b111111111111;
  // Dispatch, PCs, jobs, index buffer, global regfile set in each demo
}

static void init_vga() {
  /* irq_enable_user0(1); */
  VGA->INTMASK.reg = VGA_INTFLAG_VBLANK;
