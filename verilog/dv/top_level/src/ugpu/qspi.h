...
#define QSPI_MEM_SIZE          (32000000UL / 8UL)
#define QSPI0_MEM_ADDR_DEFAULT (0 * QSPI_MEM_SIZE)
#define QSPI1_MEM_ADDR_DEFAULT (1 * QSPI_MEM_SIZE)
#define QSPI2_MEM_ADDR_DEFAULT (2 * QSPI_MEM_SIZE)
