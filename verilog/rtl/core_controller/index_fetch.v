...
module index_fetch_m #(
    ...
    reg  [`WORD] index_buffer_offset; // In *indices* (words)
    wire [`WORD] index_buffer_offset_bytes = {index_buffer_offset[29:0], 2'b00};
    reg [2:0]   state;
    ...
    always @(posedge clk_i, negedge nrst_i) begin
        if (!nrst_i) begin
            ...
            case (state)
                ...
                STATE_PREP: begin
                    mport_o[`BUS_MO_ADDR] <= index_buffer_addr_i + index_buffer_offset_bytes;
