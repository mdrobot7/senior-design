...
module dispatch_m #(
  ...
  input wire fetch_from_memory_i,   // Dispatch using index buffer and shaded vertex cache
  ...
  output reg dispatch_done_o,
  output reg model_done_o,
);
  ...
  assign model_done_o = index_fetch_model_done;
