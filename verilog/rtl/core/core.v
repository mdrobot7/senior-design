...
module core_m(
    ...
    wire[`REG_DEST_WIDTH-1:0] dec_r1_addr;
    ...
    wire [`WORD_WIDTH-1:0] outbox [`CORE_OUTBOX_HEIGHT-1:0];
    ...
    assign dec_r1_addr = (dec_ctl_sigs[`IMM_SIZE_IDX] == `IMM_16_BIT) ? dec_inst[`REG_DEST_IDX] : dec_inst[`R1_LOCAL_IDX];
    ...
    assign halt_stall = (wb_inst[`OPCODE_IDX] == `HALT_OPCODE);
