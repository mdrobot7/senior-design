module core_m(
    ...
    output wire[`WORD_WIDTH-1:0] mem_addr_o,
    ...
    assign is_load_o = mem_ctl_sigs[`IS_LOAD_IDX];
    assign is_store_o = mem_ctl_sigs[`IS_STORE_IDX];
    ...
    always @ (posedge clk_i, negedge nrst_i) begin
        ...
        if(!nrst_i) begin : RESET
            ...
            piped_mem_result[`STAGE_SLICE(WB_STAGE, `WORD_WIDTH)] <= mem_data_i;
