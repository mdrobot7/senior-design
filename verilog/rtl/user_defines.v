...
// Caravel includes are handled in includes.rtl.caravel_user_project and
// the paths are a little weird, so `include doesn't work well. SVUnit
// has to include this file directly, so handle that here.
`ifdef SVUNIT
