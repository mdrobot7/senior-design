...
// addresses
`define ADDR_FB0           (1 * `SPI_MEM_SIZE + 320 * 240 * 1)
`define ADDR_FB1           (1 * `SPI_MEM_SIZE + 320 * 240 * 2)
`define ADDR_DEPTH_BUFFER  (2 * `SPI_MEM_SIZE)
`define ADDR_TEX_BUFFER    (2 * `SPI_MEM_SIZE + 655360)
`define ADDR_INDEX_BUFFER  (2 * `SPI_MEM_SIZE + 524288)
`define ADDR_VERTEX_BUFFER (2 * `SPI_MEM_SIZE + 589824)
